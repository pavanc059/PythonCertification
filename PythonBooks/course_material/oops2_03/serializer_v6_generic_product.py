...
def serialize(object_to_serialize, data_format):
    # creator now returns the product instance
    # no need to instantiate serializer_product() anymore
    # this merges 2 lines of code into 1
...
# Creator
# -------
# move product instantiation into the creator
def _get_serializer(data_format):
    if data_format == "JSON":
        # return _SerializeToJson class instance
        return _JSONSerializer()
    elif data_format == "XML":
        # return _serialize_to_xml class instance
